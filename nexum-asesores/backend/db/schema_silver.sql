-- ============================================================
-- Nexum Asesores — Schema SILVER (PostgreSQL)
-- Datos normalizados, deduplicados y validados
-- Origen: Bronze (MinIO) → Silver (este schema)
-- ============================================================
...
-- ════════════════════════════════════════════════════════════
-- stg_facturas — Facturas electrónicas normalizadas
...
CREATE TABLE IF NOT EXISTS silver.stg_facturas (
    ...
    cliente_id          TEXT NOT NULL,                 -- FK lógica a cliente
    ...
    -- Validación KYC (cruce con RENIEC)
    ...
    hash_contenido      TEXT,                          -- SHA-256 para deduplicación
...
-- ════════════════════════════════════════════════════════════
-- stg_reniec_padron — Padrón nacional de identidad (RENIEC)
-- ════════════════════════════════════════════════════════════
CREATE TABLE IF NOT EXISTS silver.stg_reniec_padron (
    ...
    ubigeo              TEXT,                          -- código geográfico de residencia
...
-- ════════════════════════════════════════════════════════════
-- stg_declaraciones — Declaraciones fiscales históricas
...
-- ════════════════════════════════════════════════════════════
-- stg_pagos — Pagos y cobros registrados
...
-- ════════════════════════════════════════════════════════════
-- stg_clientes — Maestro de clientes
-- ════════════════════════════════════════════════════════════
